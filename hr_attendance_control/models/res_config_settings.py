...
class ResConfigSettings(models.TransientModel):
    ...
    attendance_restrict_login = fields.Boolean(
        ...
        config_parameter='hr_attendance_control.restrict_login',
    ...
    attendance_force_checkout = fields.Boolean(
        ...
        config_parameter='hr_attendance_control.force_checkout',
        default=True,
    ...
    attendance_checkout_previous_days = fields.Boolean(
        ...
        config_parameter='hr_attendance_control.checkout_previous_days',
        default=True,
